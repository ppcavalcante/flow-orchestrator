...
> `@latest` resolves to the highest pre-release — currently **`v0.22.1-alpha`** — which the command
> above installs. Pinning `@v0.22.1-alpha` is optional but recommended for reproducibility; the API
