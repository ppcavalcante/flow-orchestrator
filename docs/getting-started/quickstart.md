...
> `@latest` resolves to the highest pre-release — currently **`v0.8.0-alpha`** — which the command
> above installs. Pinning `@v0.8.0-alpha` is optional but recommended for reproducibility; the API
