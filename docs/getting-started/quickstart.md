...
> `@latest` resolves to the highest pre-release — currently **`v0.7.4-alpha`** — which the command
> above installs. Pinning `@v0.7.4-alpha` is optional but recommended for reproducibility; the API
